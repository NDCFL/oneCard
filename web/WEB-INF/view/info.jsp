...
<head>
	...
	<link rel="stylesheet" href="<%=path%>/css/weui.min.css?201711-11" >
...
<div class="weui-msg me-main clearfix">
        <div class="weui-cells" style="margin-top:-30px">
            <a class="weui-cell head-cells weui-cell_access" href="javascript:void(0);">
        ...
        fields: {
            ...
            userCard: {
                ...
                validators: {
                    ...
                    threshold: 3,
                    remote: {
                        url: '<%=path%>/login/checkKh/${userVo.userName}',
                        message: '卡号不存在或已被绑定',
                        delay :  2000,
                        type: 'POST'
                    }
